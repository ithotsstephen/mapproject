-- Persecution Tracker Database Schema with Updated Credentials
...
-- Insert updated super admin user
-- Username: projectadmin | Password: ProjectDemo2024!
...
-- Insert updated admin user  
-- Username: demoAdmin | Password: DemoAdmin2024!
INSERT INTO users (name, username, email, password, role, status, created_at) VALUES
