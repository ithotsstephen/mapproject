-- Updated Database Schema for mapproject (includes post_images table and admin_approval status)
-- Database: incident_tracker
-- Run this to recreate/replace the existing schema (backup your data first!)
...
CREATE TABLE IF NOT EXISTS posts (
    ...
    tags TEXT,
    status ENUM('draft', 'admin_approval', 'published', 'unpublished') DEFAULT 'draft',
...
-- Table to store multiple images per post (gallery)
